    ...
    <>
      ...
      <div className="suck absolute w-full bg-cover -z-10 top-0 left-0 h-full opacity-[1]"></div>
        <div className='text-white z-50 relative'>
            <h3 className='text-[2.5rem] font-medium leading-[3.8rem] text-center w-[38rem]'>Thanks for choosing Wises. <br/>Our team will contact you soon.
            </h3>
            <h1 className='text-center text-xl mt-5'>Know more about <span className='text-[#1dfbc5] lis relative after:bottom-[-3px] after:h-[1px]'><Link href={"/"}>our services.</Link></span></h1>
        </div>
    </section>
<Footer/>
    </>
